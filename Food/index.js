...
function displayItems() {
  ...
  biryaniData.map((item) => {
    ...
    itemPrice.innerText = "Price : $130 " + item.price;
  ...
  chickenData.map((item) => {
    ...
    var itemPrice = document.createElement("p");
    itemPrice.setAttribute("id", "item-price");
    itemPrice.innerText = "Price : $100 " + item.price;
  ...
  paneerData.map((item) => {
    ...
    star.setAttribute("class", "fa fa-star");
    star.setAttribute("id", "rating");
    star.innerText = "4.3" + item.rating;
    ...
    var itemPrice = document.createElement("p");
    itemPrice.setAttribute("id", "item-price");
    itemPrice.innerText = "Price : $150 " + item.price;
  ...
  vegetableData.map((item) => {
    ...
    var itemPrice = document.createElement("p");
    itemPrice.setAttribute("id", "item-price");
    itemPrice.innerText = "Price : $70" + item.price;
  ...
  chineseData.map((item) => {
    ...
    var itemPrice = document.createElement("p");
    itemPrice.setAttribute("id", "item-price");
    itemPrice.innerText = "Price : $180" + item.price;
  ...
  southData.map((item) => {
    ...
    star.setAttribute("class", "fa fa-star");
    star.setAttribute("id", "rating");
    star.innerText = "4.5" + item.rating;
    ...
    var itemPrice = document.createElement("p");
    itemPrice.setAttribute("id", "item-price");
    itemPrice.innerText = "Price : $40" + item.price;
